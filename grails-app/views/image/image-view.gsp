...
<div style="float: left; text-align: left; padding-left: 20px; width: 70%;">
    <h4 style="display: inline;">
        ...
        conventions that I have to learn in order to be fully productive in this framework. I am confident that with some
        initial effort and the help of experienced people the learning curve can be passed with ease."</em>
    </h4>
</div>
